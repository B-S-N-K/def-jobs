      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="bg-white border-[1.5px] border-shield-border-l rounded-2xl p-8 mb-8">
          ...
          <p className="text-shield-text-lm leading-relaxed mb-4">
            Shield Talent was built to solve a real problem: defense and security companies struggle to find qualified civilian talent, while skilled professionals have no dedicated platform to find opportunities in this sector.
          </p>
        ...
        <div className="bg-white border-[1.5px] border-shield-border-l rounded-2xl p-8 mb-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="font-heading font-bold text-2xl text-shield-text-l uppercase tracking-wide">Why Shield Talent?</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { title: 'Sector Focused', desc: 'Unlike general job boards, every listing on Shield Talent is in defense, aerospace or security. No noise, only relevant opportunities.' },
        ...
        <div className="bg-white border-[1.5px] border-shield-border-l rounded-2xl p-8 mb-8">
          ...
          <p className="text-shield-text-lm leading-relaxed mb-4">
            Shield Talent covers civilian roles across the full defense supply chain — from prime contractors to tier-2 suppliers. Our listings span engineering, IT & cybersecurity, logistics, manufacturing, management, finance and administration.
          </p>
          <p className="text-shield-text-lm leading-relaxed">
