        ...
        <div className="bg-white border-[1.5px] border-shield-border-l rounded-2xl p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-shield-text-lm leading-relaxed">
              By accessing or using Shield Talent ("the platform"), you agree to be bound by these Terms of Service. If you do not agree, please do not use the platform.
            </p>
          </section>

          <section>
            <h2 className="font-heading font-bold text-xl text-shield-text-l uppercase tracking-wide mb-3">2. Use of the Platform</h2>
            <p className="text-shield-text-lm leading-relaxed mb-3">You agree to use Shield Talent only for lawful purposes. You must not:</p>
          ...
          <section>
            ...
            <p className="text-shield-text-lm leading-relaxed">
              Employers are responsible for the accuracy and legality of their job listings. Shield Talent reserves the right to remove any listing that violates these terms or is deemed inappropriate. Job listings are published for the duration specified in the selected pricing plan.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-shield-text-lm leading-relaxed">
              All content on Shield Talent — including the logo, design, and written content — is the property of Shield Talent. You may not reproduce or distribute any content without written permission.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-shield-text-lm leading-relaxed">
              Shield Talent acts as a platform connecting employers and candidates. We are not responsible for the outcome of any hiring process, the accuracy of job descriptions, or any disputes between employers and candidates.
            </p>
          </section>
