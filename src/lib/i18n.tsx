...
export const translations = {
  cs: {
    ...
    featured_label2: ' inzerující na DefHire',
    ...
    footer_company: 'DEFHIRE',
    footer_about: 'O nás',
    footer_privacy: 'Ochrana soukromí',
    footer_terms: 'Podmínky použití',
    footer_contact: 'Kontakt',
    footer_copy: '© 2026 DefHire. Všechna práva vyhrazena.',
    ...
    pricing_f5: 'Zařazení do databáze DefHire',
  ...
  en: {
    ...
    featured_label2: ' hiring on DefHire',
    ...
    footer_copy: '© 2026 DefHire. All rights reserved.',
    footer_tag: 'Defense Talent. Delivered.',
    ...
    pricing_f5: 'Listed in DefHire candidate pool',
